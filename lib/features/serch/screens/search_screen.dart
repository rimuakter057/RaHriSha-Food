...
class SearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Search your recipe",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),),
        leading: IconButton(
          onPressed: () => Get.back(),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              sectionTitle(title: 'Recent Searches', text: 'Clear all'),
              ...
              const SizedBox(height: 24.0),
              sectionTitle(title: 'Popular Categories', text: ''),
              const SizedBox(height: 8.0),
              SizedBox(
                height: 100,
              ...
              const SizedBox(height: 24.0),
              sectionTitle(title: 'Trending Now', text: ''),
              const SizedBox(height: 8.0),
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, index) => trendingItems[index],
                ),
              ),

              const SizedBox(height: 24.0),
              sectionTitle(title: 'Popular Searches', text: ''),
              const SizedBox(height: 8.0),
              Wrap(
                spacing: 12.0,
                runSpacing: 8.0,
              ...
              const SizedBox(height: 24.0),
              sectionTitle(title: 'Suggested For You', text: ''),
              const SizedBox(height: 8.0),
              SizedBox(
                height: screenWidth * 0.6,
                child: ListView.separated(
                  ...
                  separatorBuilder: (_, __) => const SizedBox(width: 12.0),
                  itemBuilder: (_, index) => suggestedItems[index],
                ),
              ),
            ],
          ),
...
// Section Title
Widget sectionTitle({required String title, required String? text}) {
  return Row(
...
final List<Widget> suggestedItems = [
  foodItemCard(
